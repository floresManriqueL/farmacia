    ...
    <div style="background-color: rgb(41, 60, 72);" id="wrapper">
        ...
        <nav style="background-color: rgb(50,50,50);" class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div style="background-color: rgb(50,50,50);" class="navbar-header">
                ...
                <a style="background-color: rgb(50,50,50);" class="user-section" href="index.html">
        ...
        <nav style="background-color: rgb(150,150,150);" class="navbar-default navbar-static-side" role="navigation">
            ...
            <div style="background-color: rgb(150,150,150);" class="sidebar-collapse">
                ...
                <ul style="background-color: rgb(41, 60, 72);"class="nav" id="side-menu">
                    ...
                    <li>
                        <!-- user image section-->
                        <div style="background-color: rgb(100,100,100);" class="user-section">
                    ...
                    <li>
                     ...
                     <li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#"><i class="icon fa fa-circle-o"></i> Agregar Producto</a>
                            </li>
                            <li>
                                <a href="#"><i class="icon fa fa-circle-o"></i> Listar Producto</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="docs/fm_categoria.php"><i class="icon fa fa-circle-o"></i> Agregar Categoria</a>
                            </li>
                            <li>
                                <a href="docs/tb_listacategoria.php"><i class="icon fa fa-circle-o"></i> Listar Categoria</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
