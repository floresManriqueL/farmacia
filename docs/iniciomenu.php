...
<body>
    ...
    <div style="background-color: rgb(41, 60, 72);" id="wrapper">
        ...
        <nav style="background-color: rgb(50,50,50);" class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div style="background-color: rgb(50,50,50);" class="navbar-header">
                ...
                <a style="background-color: rgb(50,50,50);" class="user-section" href="iniciomenu.php">
                    <br>
                    <img style="width: 68px; height: auto;" src="../assets/img/logo2.png" alt="" ></img>
                </a>
            </div>
        ...
        <!-- navbar side -->
        <nav  style="background-color: rgb(150,150,150);" class="navbar-default navbar-static-side" role="navigation">
            <!-- sidebar-collapse -->
            <div style="background-color: rgb(150,150,150);" class="sidebar-collapse">
                <!-- side-menu -->
                ...
                <ul style="background-color: rgb(41, 60, 72);"class="nav" id="side-menu">
                   ...
                   // echo $_SESSION['idempleado'];
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="fm_venta.php"><i class="icon fa fa-circle-o"></i> Relizar Venta</a>
                            </li>
                            <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-heartbeat" aria-hidden="true"></i>Farmacia La Bendicion</h1>
                     ...
                     <!-- <h4>Fecha Actual:&nbsp; <?php echo fechaC(); ?></h4>
                      <h4 id="reloj"></h4>-->
                      <div class="col-lg-4">
                        <div class="alert alert-success text-center">
                        <i class="fa fa-calendar fa-3x"></i>&nbsp;&nbsp;&nbsp;<b>Fecha: </b>&nbsp; <?php echo fechaC(); ?>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div style="height: 72px;" class="alert alert-warning text-center">
                            <div class="col-lg-4">
                    ...
                    <div class="alert alert-danger text-center">
                        <i class="fa fa-bell fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>N°&nbsp;<?php echo $contador; ?> </b>Notificaciones
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>&nbsp;Hola ! </b>Bienvenido de nuevo<a href='fm_perfil.php' class='alert-link'> <b>Usuario </b>
 <i class="fa  fa-pencil"></i><b>&nbsp; </b></a> te podemos ayudar;
                    </div>
                    <?php
                    foreach ($fila as $key=> $value) {
                          if($value->getCantidad() <= 10){
                            if($value->getEstado() == "Activo"){
                             echo "<div class='alert alert-danger alert-dismissable'>
                                ...
                                El producto '".$value->getNombre()."' Tiene poco Stock Cantidad:<b>&nbsp; '".$value->getCantidad()."'</b>. <a href='tb_listaproducto.php' class='alert-link'></b>
                               <i class='fa  fa-pencil'></i> &nbsp;&nbsp;Ver Productos en Inventadorio</a>.               
                        </div>";
                    }
                }
                    } 
